    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.peopleBtns.addOnButtonCheckedListener{ toggleButton, checkedId, isChecked ->
            if(isChecked){
                when(checkedId){
                    R.id.people3_Btn -> {
                        binding.people3Btn.icon = AppCompatResources.getDrawable(applicationContext, R.drawable.checkicon)
                        binding.people4Btn.icon = null
                        binding.people5Btn.icon = null
                    }
                    R.id.people4_Btn -> {
                        binding.people3Btn.icon = null
                        binding.people4Btn.icon = AppCompatResources.getDrawable(applicationContext, R.drawable.checkicon)
                        binding.people5Btn.icon = null
                    }
                    R.id.people5_Btn -> {
                        binding.people3Btn.icon = null
                        binding.people4Btn.icon = null
                        binding.people5Btn.icon = AppCompatResources.getDrawable(applicationContext, R.drawable.checkicon)
                    }
        ...
        binding.people3Btn.setOnClickListener {
            ...
            binding.aCardListView.layoutManager = LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL, false)


            binding.bCardListView.adapter = bAdapter
            binding.bCardListView.layoutManager = LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL, false)


            binding.cCardListView.adapter = cAdapter
            binding.cCardListView.layoutManager = LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL, false)


            binding.bottomCardListView.adapter = bottomAdapter
            binding.bottomCardListView.layoutManager = GridLayoutManager(this, 2, GridLayoutManager.HORIZONTAL, false)
        ...
        binding.people4Btn.setOnClickListener {
            ...
            binding.dCardListView.layoutManager = LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL, false)
        ...
        binding.people5Btn.setOnClickListener {
            ...
            binding.eCardListView.layoutManager  = LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL,false)

            binding.bottomCardListView.adapter = bottomAdapter
            binding.bottomCardListView.layoutManager = LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)
